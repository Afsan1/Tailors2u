...
const FABRICS = [
  ...
  {
    id: 'f6', name: 'Fine Merino Wool Suiting', color: '#315582', secondColor: '#27446b', patternType: 'wool', origin: 'Australia / Italy', weight: '270 gsm', badge: 'Super 140s Wool', desc: 'Thermoregulating Super 140s Merino suiting wool',
    variants: [
      { id: 'wl_v1',  name: 'Royal Blue',       color: '#315582', secondColor: '#27446b' },
      { id: 'wl_v2',  name: 'Espresso Brown',   color: '#5e4133', secondColor: '#4d3428' },
      { id: 'wl_v3',  name: 'Charcoal Black',   color: '#2c2e33', secondColor: '#1e2024' },
      { id: 'wl_v4',  name: 'Slate Grey',       color: '#6d757d', secondColor: '#585e65' },
      { id: 'wl_v5',  name: 'Honey Gold',       color: '#d8a04f', secondColor: '#c48e3d' },
      { id: 'wl_v6',  name: 'Sandy Khaki',      color: '#a99879', secondColor: '#948366' },
      { id: 'wl_v7',  name: 'Warm Latte',       color: '#c2ab91', secondColor: '#b0997f' },
      { id: 'wl_v8',  name: 'Dusty Mauve',      color: '#9e7c87', secondColor: '#8b6974' },
      { id: 'wl_v9',  name: 'Rich Mocha',       color: '#705345', secondColor: '#5d4134' },
      { id: 'wl_v10', name: 'Earthy Olive',     color: '#525d43', secondColor: '#424c35' },
      { id: 'wl_v11', name: 'Pearl White',      color: '#edebe6', secondColor: '#dcdad5' },
      { id: 'wl_v12', name: 'Petrol Blue',      color: '#1f4f5b', secondColor: '#153e49' },
      { id: 'wl_v13', name: 'Burgundy Wine',    color: '#6c2533', secondColor: '#591c27' },
      { id: 'wl_v14', name: 'Camel Tan',        color: '#be8c5c', secondColor: '#a97a4d' },
      { id: 'wl_v15', name: 'Dusty Lavender',   color: '#8b7e94', secondColor: '#776b80' },
      { id: 'wl_v16', name: 'Forest Pine',      color: '#254736', secondColor: '#183627' },
      { id: 'wl_v17', name: 'Plum Purple',      color: '#592743', secondColor: '#471c34' },
      { id: 'wl_v18', name: 'Rust Bouclé',      color: '#ac4d33', secondColor: '#964028' },
      { id: 'wl_v19', name: 'Sandstone Beige',  color: '#d4c2a5', secondColor: '#c2b093' },
      { id: 'wl_v20', name: 'Sapphire Blue',    color: '#1d3b66', secondColor: '#142c4f' },
    ],
  },
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'pv_v12', name: 'Neptune Green',  color: '#1d5e56', secondColor: '#144640' },
      { id: 'pv_v13', name: 'Dark Chocolate', color: '#38241d', secondColor: '#291913' },
      { id: 'pv_v14', name: 'Frosted Pink',   color: '#d8aab4', secondColor: '#c496a0' },
      { id: 'pv_v15', name: 'Oxblood Red',    color: '#52191e', secondColor: '#3d1115' },
      { id: 'pv_v16', name: 'Raspberry Red',  color: '#8b1e3f', secondColor: '#731633' },
      { id: 'pv_v17', name: 'Rust Orange',    color: '#9c4323', secondColor: '#803419' },
      { id: 'pv_v18', name: 'Teaberry Pink',  color: '#b25d74', secondColor: '#9c4d62' },
      { id: 'pv_v19', name: 'Alexandrite Teal', color: '#2a6f78', secondColor: '#205860' },
    ],
  },
];
