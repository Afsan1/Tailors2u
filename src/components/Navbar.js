    ...
    <>
      <nav className="navbar-wrapper">
        <div className="navbar-container">
          ...
          {/* Mobile menu toggle (hidden on mobile now that we use dock, but kept for desktop responsive rules or legacy stylesheet consistency if needed, we'll hide it in CSS) */}
          <button
      ...
      {/* Floating Dock for mobile screens only */}
      <FloatingDock />
    </>
  );
}
